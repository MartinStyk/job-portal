...
namespace BusinessLayer.Services.JobApplications
{
    public interface IJobApplicationService : ICrudService<JobApplicationDto, JobApplicationFilterDto>
    {
        ...
        Task<QueryResultDto<JobApplicationDto, JobApplicationFilterDto>> GetByJobOffer(int jobOfferId);
        ...
        Task<QueryResultDto<JobApplicationDto, JobApplicationFilterDto>> GetByApplicant(int applicantId);
        ...
        Task<QueryResultDto<JobApplicationDto, JobApplicationFilterDto>> GetByFilter(JobApplicationFilterDto filter);
